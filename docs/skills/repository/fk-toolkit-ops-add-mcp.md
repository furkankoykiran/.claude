...
| field | value |
| --- | --- |
| skill-name | fk-toolkit-ops:add-mcp |
| source | repository |
| pack | repository |
| relative-path | skills/fk-toolkit-ops/skills/add-mcp/SKILL.md |
| digest | sha256:bb81b7ebbe818be98c03a6eebea6105f768848ff2d68873b82f46536194678e5 |
| redistribution | full |
