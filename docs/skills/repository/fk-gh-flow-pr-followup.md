...
| field | value |
| --- | --- |
| skill-name | fk-gh-flow:pr-followup |
| source | repository |
| pack | repository |
| relative-path | skills/fk-gh-flow/skills/pr-followup/SKILL.md |
| digest | sha256:07b6ed2daaa879b502e1b72557b1ef013fe3cbd60e145d67784589fddc47d039 |
| redistribution | full |

## Description

Read a pull request's latest review discussion and act on the pending feedback. Use for "follow up on PR
