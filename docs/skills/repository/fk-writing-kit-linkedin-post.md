...
| field | value |
| --- | --- |
| skill-name | fk-writing-kit:linkedin-post |
| source | repository |
| pack | repository |
| relative-path | skills/fk-writing-kit/skills/linkedin-post/SKILL.md |
| digest | sha256:47227dfc22aee9e7ec0381f7423f4d1c288b7311c608902991ab4665fa3e8d5a |
| redistribution | full |

## Description

Turn a blog post, URL or chat context into a formatted LinkedIn post. Use to share an article on LinkedIn or repurpose content as LinkedIn copy.
