...
| field | value |
| --- | --- |
| skill-name | fk-writing-kit:blog-from-chat |
| source | repository |
| pack | repository |
| relative-path | skills/fk-writing-kit/skills/blog-from-chat/SKILL.md |
| digest | sha256:93b7a8d997f3002e5b782203a90817d21b2f35051006481b60a5ac8170ba958b |
| redistribution | full |

## Description

Turn a chat log, conversation or discussion summary into a publishable blog post, in one or more languages. Use for "blog from this chat" or "write up our conversation".
