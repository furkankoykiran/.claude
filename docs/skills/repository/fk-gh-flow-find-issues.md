...
| field | value |
| --- | --- |
| skill-name | fk-gh-flow:find-issues |
| source | repository |
| pack | repository |
| relative-path | skills/fk-gh-flow/skills/find-issues/SKILL.md |
| digest | sha256:afacaa7337a7ac8790b578eb3306b62c0946de09e30488b123a55f0340eabdce |
| redistribution | full |
