...
| field | value |
| --- | --- |
| skill-name | fk-gh-flow:github-comment |
| source | repository |
| pack | repository |
| relative-path | skills/fk-gh-flow/skills/github-comment/SKILL.md |
| version | 1.0.0 |
| allowed-tools | Read, Edit, Grep, Glob, Bash, AskUserQuestion, mcp__github__issue_read, mcp__github__pull_request_read |
| digest | sha256:4884e5e87865ac81b5dd87a372da8efdf10ce572e0754a1c4d62c2eb30cdb219 |
| redistribution | full |
| security-flags | bash/powershell tool |

## Description

Write GitHub issue comments, PR descriptions and review replies that read like a real developer wrote them, matching the thread's existing tone. Use before posting anything to a GitHub conversation.
