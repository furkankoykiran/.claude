...
| relative-path | cso/SKILL.md |
| version | 3.0.0 |
| allowed-tools | Bash(~/.claude/skills/gstack/bin/gstack-cso-launcher *), Bash(~/.claude/skills/gstack/bin/gstack-cso-launcher.exe *) |
| digest | sha256:dbcb4964274330aca43ee7ccb0c8092e5791ae22eb51d92365efc72b7ac50397 |
| redistribution | full |
