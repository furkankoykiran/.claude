...
| relative-path | gstack-upgrade/SKILL.md |
| version | 1.1.0 |
| allowed-tools | Bash, Read, Write, AskUserQuestion |
| digest | sha256:1e2425d5f0f5e62df951dde80f09c3fb57e1d8f7cb535b94165723961a6e0f15 |
| redistribution | full |
| security-flags | bash/powershell tool, network-access, executables:13 |
