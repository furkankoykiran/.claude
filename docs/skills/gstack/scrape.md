...
<!-- Source: gstack · revision 0530392821c277b95e5cd65aa9d9fda4248718b2 -->
...
| ref | origin/HEAD |
| resolved-revision | 0530392821c277b95e5cd65aa9d9fda4248718b2 |
| relative-path | scrape/SKILL.md |
| version | 2.0.0 |
| preamble-tier | 1 |
| allowed-tools | Bash, Read, AskUserQuestion |
| digest | sha256:1e78726f908d4912a6a30971993489fc69c725dffe49d61e106fcaa1d643a758 |
| redistribution | full |
| security-flags | bash/powershell tool, network-access |

## Description

Pull data from a web page through the Aside browser — your real, already signed-in sessions. (gstack)
